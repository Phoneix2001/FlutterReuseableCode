...
//
//     final allCustodians = allCustodiansFromJson(jsonString);

import 'dart:convert';

List<AllCustodians> allCustodiansFromJson(String str) => List<AllCustodians>.from(json.decode(str).map((x) => AllCustodians.fromJson(x)));

String allCustodiansToJson(List<AllCustodians> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class AllCustodians {
  ...
  factory AllCustodians.fromJson(Map<String, dynamic> json) => AllCustodians(
